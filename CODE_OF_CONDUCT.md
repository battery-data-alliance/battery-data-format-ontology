...
Examples of representing this project include using an official email address,
...
reported by using the private GitHub Security Advisory form:
https://github.com/BatteryDataAlliance/BDAOntology/security/advisories/new
