...
.. code-block:: json

   {
     ...
     "@id": "https://w3id.org/battery-data-alliance/ontology/battery-data-format/schema/vendors/novonix-csv",
...
1. Create ``schema/vendors/{manufacturer}-{format}.json`` following the structure above.
